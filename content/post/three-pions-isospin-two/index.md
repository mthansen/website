...
title: "Isotensor three-pion scattering"
subtitle: ""
summary: Summary of recent work predicting the isotensor three-pion scattering amplitude using lattice QCD
authors: []
tags: []
categories: []
...
links:
  - name: arXiv
    url: https://arxiv.org/pdf/2510.24894
  # - name: PRL
...
An informal summary of: [_Isotensor $\pi\pi\pi$ scattering with a $\rho$ resonant subsystem from QCD_]({{< ref "/publication/hansen-2020-otl" >}}) will be added here in the near future.
